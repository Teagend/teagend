...
$txt['teagend_installer'] = 'Teagend Installer';
...
$txt['congratulations_help'] = 'If at any time you need support, or Teagend fails to work properly, please remember that <a href="https://teagend.org/" target="_blank" rel="noopener">help is available</a> if you need it.';
...
$txt['go_to_your_forum'] = 'Now you can see <a href="%1$s">your newly set up community</a> and begin to use it. You should first make sure you are logged in, after which you will be able to access the administration center.';
$txt['good_luck'] = 'Good luck!<br>Teagend';

$txt['install_welcome'] = 'Welcome';
$txt['install_welcome_desc'] = 'Welcome to Teagend. We\'re going to guide you through the process for installing %1$s. We will gather a few details about your community over the next few steps, and after a couple of minutes your community will be ready for you.';
$txt['install_no_https'] = 'Your environment does not support https streams.  Certain functions, e.g., receiving updates from teagend.org, will not work.';
...
$txt['default_topic_subject'] = 'Welcome to Teagend!';
$txt['default_topic_message'] = 'Welcome to Teagend!<br><br>We hope you enjoy building your community.&nbsp; If you have any problems, please feel free to [url=https://teagend.org/]ask us for assistance[/url].<br><br>Thanks!<br>Teagend';
...
$txt['default_news'] = 'Teagend - freshly made!';
...
$txt['default_theme_name'] = 'Teagend Default Theme - Curve2';
...
$txt['install_settings_info'] = 'This page requires you to define a few key settings for your forum. Teagend has automatically detected key settings for you.';
...
$txt['db_settings_database_info'] = 'Fill in the name of the database you want to use for Teagend to store its data in.';
...
$txt['user_settings_server_email_info'] = 'Provide <strong>the email address that Teagend will use to send emails</strong>. This must be a valid email address!';
...
$txt['ftp_setup_why_info'] = 'Some files need to be writable for Teagend to work properly. This step allows you to let the installer make them writable for you. However, in some cases it will not work. In this case, please make the following files 777 (writable, 755 on some hosts):';
...
$txt['error_windows_chmod'] = 'You are on a windows server and some crucial files are not writable. Please ask your host to give <strong>write permissions</strong> to the user PHP is running under for the files in your Teagend installation. The following files or directories need to be writable:';
...
$txt['error_db_database'] = 'The installer was unable to access the &quot;<em>%1$s</em>&quot; database. With some hosts, you have to create the database in your administration panel before Teagend can use it. Some also add prefixes, such as your username, to your database names.';
...
$txt['error_db_alter_priv'] = 'The database account you specified does not have permission to ALTER, CREATE, and/or DROP tables in the database. This is necessary for Teagend to function properly.';
$txt['error_versions_do_not_match'] = 'The installer has detected another version of Teagend already installed with the specified information. If you are trying to upgrade, you should use the upgrader, not the installer.<br><br>Otherwise, you may wish to use different information, or create a backup and then delete the data currently in the database.';
$txt['error_mod_security'] = 'The installer has detected the mod_security module is installed on your web server. Mod_security will block submitted forms even before Teagend gets a say in anything. Teagend has a built-in security scanner that will work more effectively than mod_security and that won\'t block submitted forms.<br><br><a href="https://www.simplemachines.org/redirect/mod_security">More information about disabling mod_security</a>';
$txt['error_mod_security_no_write'] = 'The installer has detected the mod_security module is installed on your web server. Mod_security will block submitted forms even before Teagend gets a say in anything. Teagend has a built-in security scanner that will work more effectively than mod_security and that won\'t block submitted forms.<br><br><a href="https://www.simplemachines.org/redirect/mod_security">More information about disabling mod_security</a><br><br>Alternatively, you may wish to use your ftp client to chmod .htaccess in the forum directory to be writable (777), and then refresh this page.';
$txt['error_utf8_version'] = 'The current version of your database doesn\'t support the use of the UTF-8 character set. You can still install Teagend without any problems, but only with UTF-8 support unchecked. If you would like to switch over to UTF-8 in the future (e.g. after the database server of your forum has been upgraded to version >= %1$s), you can convert your forum to UTF-8 through the admin panel.';
...
$txt['error_already_installed'] = 'The installer has detected that you already have Teagend installed. It is strongly advised that you do <strong>not</strong> try to overwrite an existing installation, continuing with installation <strong>may result in the loss or corruption of existing data</strong>.<br><br>If you wish to upgrade please visit the <a href="https://teagend.org/">Teagend community</a> and download the latest <em>upgrade</em> package.<br><br>If you wish to overwrite your existing installation, including all data, it is recommended that you delete the existing database tables and replace Settings.php and try again.';
$txt['error_warning_notice'] = 'Warning!';
$txt['error_script_outdated'] = 'This install script is out of date! The current version of Teagend is %1$s, but this install script is for %2$s.<br><br>
	It is recommended that you visit the <a href="https://teagend.org">Teagend</a> website to ensure you are installing the latest version.';
...
$txt['ftp_login_info'] = 'This web installer needs your FTP information in order to automate the installation for you. Please note that none of this information is saved in your installation, it is just used to setup Teagend.';
...
$txt['upgrade_upgrade_utility'] = 'Teagend Upgrade Utility';
...
$txt['upgrade_done'] = 'Upgrade complete. Now you are ready to use <a href="%1$s/index.php">your installation of Teagend</a>. Hope you like it!';

$txt['upgrade_delete_now'] = 'Delete upgrade.php and its data files now';
$txt['upgrade_delete_server'] = '(does not work on all servers).';
$txt['upgrade_problems'] = 'If you had any problems with this upgrade, or have any problems using Teagend, please do not hesitate to <a href="%1$s">ask us for assistance</a>.';
...
$txt['upgrade_ready_proceed'] = 'Thank you for choosing to upgrade to Teagend %1$s. All files appear to be in place and the upgrade can now proceed.';
...
$txt['error_unexpected_template_call'] = 'Error: Unexpected call to use the %1$s template. Please copy and paste all the text above and visit the Teagend community to let the developers know that there is a bug.';
$txt['error_invalid_template'] = 'Upgrade aborted!  Invalid template: template_%1$s';
$txt['error_lang_index_missing'] = 'The upgrader was unable to find language files for the selected language, %1$s.<br>Teagend will not work in this language without the language files installed.<br><br>Please either install them, or <a href="%2$s?step=0;lang=english">try English instead</a>.';
...
$txt['error_php_too_low'] = 'Warning!  You do not appear to have a version of PHP installed on your webserver that meets Teagend\'s minimum installations requirements.<br><br>Please ask your host to upgrade.';
$txt['error_db_too_low'] = 'Your %1$s version does not meet the minimum requirements of Teagend.<br><br>Please ask your host to upgrade.';
...
// Page titles
$txt['updating_smf_installation'] = 'Updating Your Teagend Installation!';
