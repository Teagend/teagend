...
/**
 * Uncategorised tables in the Teagend schema.
 *
 * @package Teagend
...
namespace Teagend\Schema\TableGroup;

use Teagend\Schema\Table;
use Teagend\Schema\Column;
use Teagend\Schema\Index;
use Teagend\Schema\Constraint;

/**
 * Uncategories tables in the Teagend schema.
 */
class Uncategorised
{
	/**
		...
		return [
			...
			Table::make('attachments',
				...
				[
					...
					Index::unique(['id_member', 'id_attach']),
					Index::key(['id_msg']),
			...
			Table::make('avatars',
				[
					'id_avatar' => Column::int()->auto_increment(),
				...
				[
					Index::primary(['id_avatar']),
					Index::key(['id_character']),
				],
				[
					Constraint::from('avatars.id_character')->to('characters.id_character'),
					Constraint::from('avatars.id_file')->to('files.id_file'),
				],
			),
			...
			Table::make('board_permissions_view',
				[
					'id_group' => Column::smallint()->signed(),
				...
				[
					Index::primary(['id_group', 'id_board', 'deny']),
				],
			),
			Table::make('boards',
				[
					...
					'unapproved_topics' => Column::smallint(),
			...
			Table::make('calendar',
				[
					'id_event' => Column::smallint()->auto_increment(),
					...
					'timezone' => Column::varchar(80)->nullable(),
					'location' => Column::varchar(255),
				],
				[
					Index::primary(['id_event']),
					Index::key(['start_date']),
					Index::key(['end_date']),
					Index::key(['id_topic', 'id_member']),
				],
			),
			Table::make('calendar_holidays',
				[
					'id_holiday' => Column::smallint()->auto_increment(),
					'event_date' => Column::date(),
					'title' => Column::varchar(255),
				],
				[
					Index::primary(['id_holiday']),
					Index::key(['event_date']),
				],
			),
			...
			Table::make('characters',
				[
					...
					'char_topic' => Column::int(),
					'retired' => Column::tinyint(),
					'is_npc' => Column::tinyint(),
				],
				[
			...
			Table::make('files',
				[
					...
					'filetype' => Column::varchar(32),
					'content_id' => Column::int(),
					'content_sub_id' => Column::int(),
					'filename' => Column::varchar(255),
				...
				[
					Index::primary(['id']),
					Index::key(['filetype', 'content_id', 'content_sub_id']),
				],
			),
			...
			Table::make('log_errors',
				[
					...
					'backtrace' => Column::varchar(10000),
				],
				[
			...
			Table::make('log_packages',
				[
					'id_install' => Column::int()->auto_increment(),
					'filename' => Column::varchar(255),
					'package_id' => Column::varchar(255),
					'name' => Column::varchar(255),
					'version' => Column::varchar(255),
					'id_member_installed' => Column::mediumint(),
					'member_installed' => Column::varchar(255),
					'time_installed' => Column::int(),
					'id_member_removed' => Column::mediumint(),
					'member_removed' => Column::varchar(255),
					'time_removed' => Column::int(),
					'install_state' => Column::tinyint()->default(1),
					'failed_steps' => Column::text(),
					'themes_installed' => Column::varchar(255),
					'db_changes' => Column::text(),
					'credits' => Column::text(),
					'sha256_hash' => Column::text(),
				],
				[
					Index::primary(['id_install']),
					Index::key(['filename' => 15]),
				],
			),
			...
			Table::make('log_spider_hits',
				[
					'id_hit' => Column::int()->auto_increment(),
					'id_spider' => Column::smallint(),
					'log_time' => Column::int(),
				...
				[
					Index::primary(['id_hit']),
					Index::key(['id_spider']),
					Index::key(['log_time']),
					Index::key(['processed']),
				],
			),
			Table::make('log_spider_stats',
				[
					'id_spider' => Column::smallint(),
					'page_hits' => Column::int(),
					'last_seen' => Column::int(),
					'stat_date' => Column::date()->default('1004-01-01'),
				],
				[
					Index::primary(['stat_date', 'id_spider']),
				],
			),
			Table::make('log_subscribed',
				[
					...
					'old_id_group' => Column::smallint()->signed(),
			...
			Table::make('membergroups',
				[
					...
					'group_type' => Column::tinyint()->signed(),
			...
			Table::make('members',
				[
					...
					'email_address' => Column::varchar(255),
					'personal_text' => Column::varchar(255),
				...
				[
					...
					Index::key(['id_theme']),
					Index::key(['is_activated', 'real_name' => 80]),
				],
			),
			...
			Table::make('messages',
				[
					...
					'id_member' => Column::mediumint(),
					'id_character' => Column::int(),
					'id_avatar' => Column::int(),
					'id_signature' => Column::int(),
				...
				[
					...
					Index::unique(['id_board', 'id_msg', 'approved']),
			...
			Table::make('package_servers',
				[
					'id_server' => Column::smallint()->auto_increment(),
					'name' => Column::varchar(255),
					'url' => Column::varchar(255),
					'validation_url' => Column::varchar(255),
					'extra' => Column::text()->nullable(),
				],
				[
					Index::primary(['id_server']),
				],
			),
			Table::make('pages',
				[
			...
			Table::make('pages_access',
				[
					'id_page' => Column::mediumint(),
					'id_group' => Column::smallint()->signed(),
					'allow_deny' => Column::tinyint()->default(1),
				],
				[
					Index::primary(['id_page', 'id_group']),
				],
				[
					Constraint::from('pages_access.id_page')->to('pages.id_page'),
				],
			),
			...
			Table::make('signatures',
				[
					'id_signature' => Column::int()->auto_increment(),
					'id_character' => Column::int(),
					'signature' => Column::text(),
				],
				[
					Index::primary(['id_signature']),
					Index::key(['id_character']),
				],
			),
			Table::make('smileys',
			...
			Table::make('smiley_files',
				[
					'id_smiley' => Column::smallint(),
					'smiley_set' => Column::varchar(48),
					'filename' => Column::varchar(48),
				],
				[
					Index::primary(['id_smiley', 'smiley_set']),
				],
			),
			Table::make('spiders',
				[
					'id_spider' => Column::smallint()->auto_increment(),
					'spider_name' => Column::varchar(255),
					'user_agent' => Column::varchar(255),
					'ip_info' => Column::varchar(255),
				],
				[
					Index::primary(['id_spider']),
				],
			),
